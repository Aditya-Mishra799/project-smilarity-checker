...
import { Trash, Edit2, Eye, ExternalLink, ChevronDown, ChevronUp, Clock, Target, Activity } from 'lucide-react';
...
const SessionCard = ({
  ...
  return (
    <div className={`group bg-white transition-all duration-300 text-black rounded-xl border border-gray-200 shadow-sm hover:shadow-md relative overflow-hidden ${isExpanded ? 'ring-2 ring-indigo-100' : 'hover:bg-gray-50'}`}>
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              <Activity size={16} className={status === 'active' ? 'text-green-500' : 'text-red-500'} />
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="text-sm text-gray-600 flex items-center gap-2">
                    ...
                    <code className="bg-gray-100 px-2 py-0.5 rounded text-xs">{_id}</code>
                  </li>
                </ul>
              </div>
              <div>
